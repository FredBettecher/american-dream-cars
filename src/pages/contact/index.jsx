...
function ContactPage() {
  return (
    <section id="contact" className="w-screen h-full my-16 flex flex-col items-center text-[#046076]">
      <h1 className={`text-3xl uppercase ${racingSansOne.className}`}>contato</h1>
      <p className="text-xl mt-4 px-24">Entre em contato com a nossa equipe e solicite um orçamento gratuito e sem compromisso para a importação do seu carro!</p>
      <div className="flex mt-8 items-center gap-12">
        <Link href="https://wa.me/+5527996355750" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-[#059CC6]">
          ...
          <p className="ml-2 text-2xl">WhatsApp</p>
        </Link>
        <Link href="https://m.me/61560026494859" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-[#059CC6]">
          ...
          <p className="ml-2 text-2xl">Facebook</p>
        </Link>
      </div>
      <form className="mt-8 flex flex-col w-[33%] gap-2">
        <div className="flex items-center">
          <IoMail className="text-4xl mr-2" />
      ...
      <textarea placeholder="Fale sobre o seu carro clássico dos sonhos. Nos de detalhes sobre o fabricante, o modelo, o ano, as cores. A nossa equipe irá entrar em contato o mais breve possível. Vamos transformar o seu sonho em realidade!" className="form-input rounded h-32 bg-[#FFFCF5]" />
