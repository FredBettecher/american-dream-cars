...
function CallToAction() {
  return (
    <section id="howItWorks" className="w-scree h-full flex flex-col items-center justify-center text-[#046076]">
      ...
      <div className="flex">
        ...
        <div className="bg-[#046076] w-[14rem] h-[8rem] flex items-center justify-center mt-20">
          <img src="/images/car2.webp" alt="chevrolet bel air" className="w-[12rem] shadow-[0px_5px_10px_rgba(0,0,0,0.5)]" />
        </div>
      </div>
      <button className={`flex justify-center text-[#FFFCF5] text-2xl ${racingSansOne.className} uppercase bg-[#059CC6] rounded w-64 h-fit p-2 cursor-pointer my-6 hover:bg-[#046076] active:scale-95 transition-transform duration-[30ms] ease-linear`}>
