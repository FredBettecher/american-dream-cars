...
function ImportationPage() {
  return (
    <section id="importation" className="w-screen h-full flex flex-col items-center justify-center text-[#046076] my-8 lg:my-16">
      ...
      <p className="text-[#333333] mt-4 px-2 text-justify lg:text-start lg:text-xl lg:px-24">Nosso processo de importação é meticuloso e detalhado, garantindo que cada veículo clássico chegue em perfeitas condições.</p>
